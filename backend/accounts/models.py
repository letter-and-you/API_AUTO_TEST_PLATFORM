...
LastEditTime: 2025-12-29 18:59:05
'''
...
class User(AbstractUser):
    ...
    alarm_email = models.EmailField(null=True, blank=True, verbose_name='告警邮箱')
    phone = models.CharField(max_length=20, blank=True, null=True, verbose_name='手机号')  # 保留较长的长度定义
    ...
    groups = models.ManyToManyField(
        ...
        blank=True,
        related_name='custom_user_groups',  # 自定义related_name
    ...
    user_permissions = models.ManyToManyField(
        ...
        blank=True,
        related_name='custom_user_permissions',  # 自定义related_name
        related_query_name='custom_user',
    )
